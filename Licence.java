...
//    	return true;
     ...
     */
    private long c(String str, String str2) throws SerialException {
    	System.out.println("开始hash\t"+str+"\t"+str2);
//    	if(0<1)return 1;
        int i = 0;
        if (str2.length() != 18) {
            ...
            long parseLong = (Long.parseLong(str2.substring(h, 10), 16) << 32) | Long.parseLong(str2.substring(10, 18), 16);
            ...
            try {
                ...
                long ret= ((((long) (((int) (parseLong >> 32)) ^ parseInt)) << 32) >>> 32) | -6517524747541020672L;
                System.out.println("hash "+str+"|"+str2+"\t-->"+ret);
                return ret;
            } catch (UnsupportedEncodingException e) {
                return -1;
            }
...
//        return this.c;
    ...
    public static void main(String[] args) {
		try {
			System.out.println(new Licence("hello", "a4036b2761c9583fd1"));
		} catch (SerialException e) {
			e.printStackTrace();
		}
	}
